...
import {
    COMMAND_CREATE_JOB_CONFIG, COMMAND_CREATE_REMOTE_JOB, COMMAND_EDIT_CLUSTER, COMMAND_LIST_JOB,
    COMMAND_OPEN_STORAGE, COMMAND_REFRESH_CLUSTER, COMMAND_SIMULATE_JOB,
    COMMAND_SUBMIT_JOB, COMMAND_TREEVIEW_DOUBLECLICK,
    COMMAND_TREEVIEW_OPEN_PORTAL,
    CONTEXT_CONFIGURATION_ITEM, ICON_CREATE_CONFIG, ICON_DASHBOARD, ICON_EDIT, ICON_HDFS, ICON_LIST_JOB, ICON_PAI, ICON_SIMULATE_JOB,
    ICON_SUBMIT_JOB,
...
const childNodeDefinitions: IChildNodeDefinition[] = [
    ...
    {
        title: 'treeview.node.vscode.remote.job',
        command: COMMAND_CREATE_REMOTE_JOB,
        icon: ICON_CREATE_CONFIG
    },
    {
